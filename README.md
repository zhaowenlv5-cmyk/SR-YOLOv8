# 🚀 SR-YOLOv8  
**The implementation for "Joint Super-Resolution Reconstruction for Small Traffic Sign Detection via Multitask Learning".**

# 🎯 Pipeline
An end-to-end small traffic sign detection framework that incorporates **super-resolution (SR)** and **object detection** under a unified **multi-task learning** paradigm.
