...
from .archsr import DeepLab

__all__ = "Detect", "Segment", "Pose", "Classify", "OBB", "RTDETRDecoder", "SR"

# class SR(DeepLab):
#     def __init__(self, ch = 3, c1 = 128, c2 = 256, srmode = 'EDSR'):
#         super().__init__(ch, c1, c2, srmode)
#
#     def forward(self, x):
...
#         elif self.srmode == 'EDSR_RFA':
#             x_sr_up = self.edsrrfa(x_sr)
#         elif self.srmode == 'RCAN':
#             x_sr_up = self.rcan(x_sr)
#
...
class SR(DeepLab):
    def __init__(self, ch = 3, c1 = 128, c2 = 256, srmode = 'RCAN'):
        super().__init__(ch, c1, c2, srmode)
